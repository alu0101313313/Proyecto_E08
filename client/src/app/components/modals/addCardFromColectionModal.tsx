...
}: AddCardFromCollectionModalProps) {
      ...
      try {
        ...
        if (response.ok) {
          ...
          const tradeableCards = data.filter((card: Card) => 
            card.isTradable === true && !selectedCardIds.has(card._id)
          );
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-700">
          <h2 className="text-2xl font-bold text-white">Añadir cartas de tu colección</h2>
          <button 
            onClick={onClose}
        ...
        <div className="overflow-y-auto flex-1 p-6">
          {loading ? (
            ...
            <div className="text-center text-gray-400 py-10">
              <p className="text-lg">No tienes cartas marcadas como intercambiables</p>
            </div>
          ) : (
